		...
		<span className="detailPage">
			<div className="content">
				...
				<p>
					...
					tricycle and a golf cart, stood tall at eight feet. It was a sight to
					behold, especially when it lit up the night with hundreds of lights,
					all controlled by two Arduino microcontrollers powered by onboard
					batteries.
				</p>
				<p>
					The base is a standard golf cart, chosen for stability and easy
					operation. On top of it I built an eight-foot-tall tricycle structure,
					with handlebars ten feet wide wrapped in lights and fifty six-foot
					ribbon streamers off each handle that trailed as it moved.
				</p>
				<p>
					The whole thing ran on two Arduinos driving hundreds of lights off
					onboard batteries — enough of a hardware and power-budget problem that
					it was as much an electronics build as a fabrication one.
				</p>
				<p>
					A few build photos are{" "}
		...
		<span className="detailPage">
			<div className="content">
				...
				<p>
					...
					solder to take the heat, fed propane from a regulator on a 20 lb tank
					so most of the system runs at negligible pressure. Gas seeps up
				...
				<p>
					...
					propane pools in them, and the fire traces the lines they made. Rake a
					new pattern and the flame follows it. The piece is never the same
		...
		<span className="detailPage">
			<div className="content">
				...
				<div>
					...
					<p>
						{" "}
						The quadricycle started as four scavenged aluminum “La Jolla” frames
						and a pile of aluminum tubing. I welded the frames together in
						parallel, giving it an ultra-stable platform... really lovely if
						you’re riding on sand and don’t want to face-plant. I engineered a
						self-centering steering mechanism so handling it feels effortless,
						almost like it steers itself. I even added a trunk for storage,
						because what’s the point of a ridiculous multi-person bike if you
						can’t haul snacks? A superstructure of custom aluminum struts
						supported aluminet in the day for shade, and the lights at night
					</p>
					...
					<p>
						...
						engineering. Getting the lighting system integrated cleanly required
						custom wiring and embedded code, which made the whole thing feel
						like a proper hardware project—not just a Frankenstein bike
						experiment.{" "}
					</p>
					...
					<p>
						...
						that started as a pile of scrap metal turn into a rideable, glowing,
						joy-machine felt amazing. It’s one of my favorite builds and a great
						example of what happens when I decide to mix engineering,
			...
			<div className="content">
				<div>
					...
					<ul>
						<li>
							<a
								href="https://www.youtube.com/watch?v=cpseEHA_haA"
								target="_blank"
								rel="noopener noreferrer"
							>
						...
						<li>
							<a
								href="https://github.com/ahonnecke/superfund-remediation"
								target="_blank"
								rel="noopener noreferrer"
							>
								Included materials
			...
			<div className="content">
				...
				<div>
					<p>
						...
						for pseudo-mounting an AWS Lambda filesystem locally. It’s designed
						to make serverless development feel a bit more like working with a
						local codebase—hot reloading included, by default.
					</p>
					<p>Consolo’s main features include:</p>
					<ul>
						<li>
							<strong>Hot Syncing:</strong> It can automatically sync with your
							Lambda codebase so you can make changes locally and see them take
							effect immediately.
						</li>
						<li>
							<strong>Upload and Download:</strong> You can push changes to the
							cloud or pull down the latest from a Lambda function using a
							simple flag.
						</li>
						<li>
					...
					<p>
						...
						<code>requests</code>, <code>watchdog</code>, and <code>boto3</code>
						, and is built to be both fast and developer-friendly.
					</p>
			...
			<div className="content">
				...
				<div>
					<p>
						...
						queue, subscribing it to your topic, and watching the queue—all in a
						single command.
					</p>
					...
					<p>
						...
						that it leaves nothing behind — the SQS queue and subscription exist
						only while you're watching, so you can inspect what a topic is
						emitting without standing up permanent infrastructure or touching
						the topic's real subscribers.
					</p>
					<p>
	...
	return (
		<span className="detailPage">
			<div className="content">
				...
				<div>
					<p>
						I built <strong>Jolly-Brancher</strong> to automate one of the most
						tedious parts of dev workflow: wiring up your git branches to your
						ticketing system. It’s a free and open source tool that connects
						JIRA to GitHub, and helps streamline everything from branch creation
						to PR description.
					</p>
					...
					<ul>
						...
						<li>
							...
							pre-filled with ticket details so you don’t have to copy-paste or
							write from scratch.
						</li>
						<li>
							<strong>Configurable:</strong> Set your JIRA and GitHub
							credentials in
							<code>~/.config/jolly_brancher.ini</code> and you’re ready to go.
						</li>
					</ul>
					<p>
						...
						interface, all under a <code>C-c j</code> prefix, lets you list and
						filter tickets with JQL, start work (which cuts the branch), and end
						work (which opens the PR) without leaving the editor. It even reads
						CODEOWNERS to suggest reviewers.
					</p>
					<p>
	...
	return (
		<span className="detailPage">
			<div className="content">
				...
				<div>
					<p>
						My GitHub is the fuller picture behind these tiles: the open-source
						Python CLIs I maintain on PyPI (Consolo, Snifter, Jolly-Brancher),
						one-off tools and experiments, and the commit history behind them.
						Most of what's on this site links back to a repo there.
					</p>
					<p>
	...
	return (
		<span className="detailPage">
			<div className="content">
				...
				<div>
					<p>
						I gave this talk at PyDEN, the Denver Python meetup, on why linting
						is worth the setup. The recording didn't survive the early-COVID
						scramble, so the write-up here is what remains of it.
					</p>
					<p>
						The argument: linting pays off less for the bugs it catches than for
						the cognitive load it removes. Consistent, auto-formatted code is
						code a reviewer can read without re-parsing everyone's personal
						style, which is most of what makes a review slow. I walked through
						wiring up formatters like <code>black</code> to get that consistency
						with almost no ongoing effort.
					</p>
					<p>
						What's left of the talk — the notes and materials — is{" "}
						<a href={navData.link} target="_blank" rel="noopener noreferrer">
							on GitHub
						</a>
						.
	...
	return (
		<span className="detailPage">
			<div className="content">
				...
				<div>
					<p>
						Most of my work lives on the CI/CD and infrastructure side: building
						reproducible, containerized deploys and automating the repetitive
						parts of shipping software. I've built and maintained pipelines on
						GitHub Actions, GitLab CI, CircleCI, and Bitbucket Pipelines,
						deploying to AWS and GCP.
					</p>
					<p>
						...
						team read each other's work without friction. The same instinct runs
						through the tooling I build: small, sharp utilities that remove a
						recurring chore.
					</p>
				</div>
			</div>
			...
			<div className="content">
				...
				<div>
					...
					<p>
						...
						lives on a NAS, but the NFS-over-WiFi mount tops out around 540 KB/s
						— too slow for the game to stream charts from directly. So Wayward
						converts each downloaded <code>.psarc</code> with{" "}
	...
	return (
		<span className="detailPage">
			<div className="content">
				...
				<div>
					<p>
						I built and shipped <strong>Foodie Folder</strong>, a cross-platform
						mobile app for keeping track of dishes worth remembering. You
						photograph a restaurant menu and the app returns it as structured
						dishes — title, description, price — that you can rate, annotate,
						and search later.
					</p>
					<p>
						The OCR is the interesting part: rather than classic text
						extraction, menu photos go to a small Node/Express service that runs
						them through OpenAI's GPT vision model and returns clean JSON, which
						handles the messy typography and layout of real menus far better
						than template OCR. Google Places and maps power location-aware
						discovery of nearby restaurants.
					</p>
					<p>
						The app is Expo and React Native in TypeScript, with expo-router for
						navigation, Redux Toolkit for state, and Appwrite as the
			...
			<div className="content">
				...
				<div>
					<p>
						...
						analyzing dealer responses, identifying price offers, and generating
						strategic counter-offers to push for better pricing.
					</p>
					<p>
						It runs several dealership threads at once and keeps context across
						a long back-and-forth. The backend ingests dealer emails over JMAP,
						uses an LLM to pull out the numbers that matter — price, incentives,
						conditions — and drafts the next counter-offer to advance the
						buyer's position.
					</p>
					<p>
						The backend is FastAPI on Python 3.12 with SQLModel over async
						Postgres and Alembic migrations; email flows through JMAP and Brevo,
						payments through Stripe, and auth through JWT. A React frontend sits
						on top, and the whole thing is docker-composed with deploy-on-push
						CI (auto-running migrations) to DigitalOcean.
					</p>
					<p>
	...
	return (
		<span className="detailPage">
			<div className="content">
				...
				<div>
					<p>
						I developed <strong>Rentinity</strong>, a blockchain-based platform
						for fractional real estate investment focused on NNN (Triple Net
						Lease) properties. The platform enables investors to purchase
						tokenized shares of commercial properties, creating a pathway for
						smaller investors to access previously inaccessible real estate
						markets with low-touch rental income and eventual liquidity.
					</p>
					<p>
						The system implements a complete property investment lifecycle, from
						seller onboarding and Wyoming Series LLC formation to property
						tokenization using ERC-20 tokens on the Polygon blockchain.
						Investors can purchase fractional ownership, receive automated rent
						distributions, and participate in property governance through a
					...
					<p>
						...
						table (60-day lockup, whitelisted transfers), and an admin dashboard
						for batch-minting tokens and processing rent distributions by
						ownership percentage. The design phases deliberately: an off-chain
						Postgres ledger with KYC and ACH first, migrating on-chain once the
			...
			<div className="content">
				...
				<div>
					<p>
						...
						guitar-training game that teaches fretboard fluency and ear-training
						through real-time feedback. The application allows guitarists to
						connect via any audio interface, see a target note on screen, play
						it, and receive instant visual feedback on accuracy.
					</p>
					<p>
					...
					<p>
						It's Python — Pygame for the interface, NumPy for signal processing,
						and sounddevice with aubio for pitch detection off the live audio
						input. It works with any interface, including the Rocksmith USB
						adapter, and ships a built-in tuner alongside the drills. The level
						layout is data-driven, so adding a new mode is a config change, not
						a rewrite.
					</p>
					<p>
	...
	return (
		<span className="detailPage">
			<div className="content">
				...
				<div>
					<p>
						I built <strong>Toy Contractor</strong> to generate and iteratively
						refine legal contracts from plain-English prompts. What makes it
						interesting is that it runs entirely on a self-hosted Mistral 7B
						model via Ollama — no external API, nothing leaves the box — which
						is exactly the property you'd want for anything touching contract
						text.
					</p>
					<p>
	...
	return (
		<span className="detailPage">
			<div className="content">
				...
				<div>
					<p>
						<strong>Safe Streets Colorado</strong> is a legislation tracker for
						traffic-safety bills, growing out of my street-safety advocacy. It
						follows bills through the Colorado statehouse and lays out what each
						one actually does, in plain language, for people who want to show up
						and testify but don't have time to read a statute.
					</p>
					<p>
						...
						CMS login — which keeps the whole record versioned, reviewable, and
						cheap to host on Cloudflare Pages.
					</p>
					<p>
						It's live at{" "}
						<a href={navData.link} target="_blank" rel="noopener noreferrer">
			...
			<div className="content">
				...
				<div>
					...
					<p>
						...
						and can mask values, keys, or both — optionally keeping the original
						length so a redacted file still looks plausible. It can also strip
						whole lines whose keys look sensitive. Because it reads and writes
						over stdin/stdout, it composes into a pipe:{" "}
