	...
	work: [
		{
			...
			highlights: {
				...
				ic: [
					...
					"Multi-provider LLM document-extraction pipeline (Gemini, Mistral) with Zod-typed schemas; immutable audit trail separating raw model output from human-reviewed values.",
