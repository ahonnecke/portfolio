	...
	work: [
		{
			...
			highlights: {
				cto: [
					...
					"Architected an agentic, multi-provider LLM document-extraction pipeline (Gemini, Mistral) with Zod-typed schemas and an immutable audit trail separating raw model output from human-reviewed values.",
				...
				ic: [
					...
					"Agentic, multi-provider LLM document-extraction pipeline (Gemini, Mistral) with Zod-typed schemas; immutable audit trail separating raw model output from human-reviewed values.",
